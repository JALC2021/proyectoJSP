        ...
        <div class="shoes"> 
            <div class="container"> 
                <div class="product-one">
                    <table align="center">
                        <tr align="center">
                            <td colspan="3"><h1><u>Mostrar Subcategorías</u></h1></td>
                        </tr>
                        <tr align="center">
                        ...
                        <s:iterator value="listaSubCategoria">
                            <tr>
                                ...
                                <td>
                                    <s:url action="../actions/actualizarSubCategoria" var="urlTag" >
                                        <s:param name="idSubcategoria" value="%{idSubCategoria}"></s:param>
                                    </s:url>
                                    <a href="<s:property value="#urlTag" />" ><img src="../img/icons/update.png"></a>
                                        <s:url action="../actions/ocultarSubCategoriaPorIds" var="urlTag2" >
                                            <s:param name="idSubcategoria" value="%{idSubCategoria}"></s:param>
                                        </s:url>
                        ...
                        <tr>
                            <td colspan="3"><br><a href="<s:url action="../actions/listadoCategoriaTodos"/>"><img src="../img/icons/add.png">Agregar Subcategoria</a></td>
                        </tr>
                    </table> 
                </div>
            </div>
