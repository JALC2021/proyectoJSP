        ...
        <div class="shoes"> 
            <div class="container"> 
                <div class="product-one">
                    <table>
                        <tr>
                            <td><h1>Insertar categoría</h1></td>
                        </tr>
                        <tr align="center">
                            <s:form action="/actions/anadirCategoria" validate="true">
                                <td><strong>Nombre</strong></td><s:textfield key="nombre"> </s:textfield>
                                <td><strong>Descripción</strong></td><s:textfield key="descripcion"> </s:textfield>
