        ...
        <div class="shoes"> 
            <div class="container"> 
                <div class="product-one">
                    <table>
                        <s:form action="/actions/anadirSubcategoria" validate="true">
                            <s:select label="Categorias" list="listaCategoria" listValue="nombre"  name="idCategoria" listKey="idCategoria" />
                            <td><strong>Nombre</strong></td><s:textfield key="nombre" label="Nombre"></s:textfield>
                            <td><strong>Descripción</strong></td><s:textfield key="descripcion" label="Descripción"></s:textfield>
