            ...
            <div class="container">
                <div class="top-nav">
                    <ul class="memenu skyblue"><li class="active"><a href="#">Inicio</a></li>
                        ...
                        <%
                        } else if(session.getAttribute("tipoUsuarioo").equals("admin")) {
                    ...
                    <table align="center">
                        ...
                        <s:iterator value="listaCategoria">
                            <tr>
                                ...
                                <td>
                                    <s:url action="../actions/actualizarCategoria" var="urlTag" >
                                        <s:param name="idCategoria" value="%{idCategoria}"></s:param>
                                    </s:url>
                                    <a href="<s:property value="#urlTag" />" ><img src="../img/icons/update.png" title="Actualizar Categoría"></a>
                                        <s:url action="../actions/ocultarCategoria" var="urlTag2" >
                                            <s:param name="idCategoria" value="%{idCategoria}"></s:param>
                                        </s:url>
                                    <a href="<s:property value="#urlTag2" />" ><img src="../img/icons/delete.png" title="Eliminar Categoría"></a>
                                   
                                </td>
                            </tr>
                        </s:iterator>
                        <tr>                          
                            <td colspan="3"><br><a href="../vistas/insertarCategoria.jsp"><img src="../img/icons/add.png">Insertar Categoria</a></td>
                        </tr>
                    </table> 
