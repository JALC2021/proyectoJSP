        ...
        <div class="shoes"> 
            <div class="container"> 
                <div class="product-one">   
                    <table align="center">
                        <tr align="center">
                            <td colspan="3"><h1><u>Mostrar Producto</u></h1></td>
                        </tr>
                        <tr align="center">
                        ...
                        <s:iterator value="listaProductos">
                            <tr>
                                ...
                                <td><s:property value="vendido" /></td>
                                <td><s:property value="provincia" /></td>
                                <td><s:property value="fechaAlta" /></td>
                                <td><img src="../img/products/<s:property value="imagen" />" height="150" width="120" /></td>                           
                            </tr>

                            <s:if test="tipoUsuarioo==user" >
                                <s:form action="/actions/anadirMensaje" validate="true"> 
                                    <tr>
                                        <td><s:textfield key="idUsuario" name="idUsuario" value="%{idUsuario}" label="Destinatario"></s:textfield></td>
                                        <td><s:textfield key="titulo" name="titulo" value="%{titulo}"/></td>

                                        <td><s:hidden key="idProducto" name="idProducto" value="%{idProducto}"></s:hidden></td>
                                        <td><s:hidden key="mensaje" value="%{mensaje}"/></td>
                                        <td><s:textfield key="idUsuarioLogado" name="idUsuarioLogado" value="%{#session.idUsuarioLogado}"/></td>

                                        <td><s:textarea name="mensaje" label="Mensaje"></s:textarea></td>
                                        </tr>
                                        <tr>
                                            <td><s:submit name="Enviar" label="Enviar"></s:submit></td>
                                        </tr>
                                </s:form>
                            </s:if> 
                        </s:iterator>
