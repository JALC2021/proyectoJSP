            ...
            <div class="container"> 
                <div class="product-one">   
                    <s:iterator value="listaProductos">                      
                        <s:hidden value="idProducto"/>
                        <s:property value="titulo" />                            
                        <s:url action="../actions/mostrarProductoPorID" var="urlTag2" >
                            <s:param name="idProducto" value="%{idProducto}"></s:param>
                        </s:url>
                        <br>
                        <a href="<s:property value="#urlTag2" />" ><img src="../img/icons/eye.png" title="" width="30" height="30"></a>
                        <img src="../img/products/<s:property value="imagen" />" height="150" width="120" />
                        <br>
