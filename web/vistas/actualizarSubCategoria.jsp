            ...
            <div class="container"> 
                <div class="product-one">
                    <table align="center">
                        ...
                        <s:form action="/actions/actualizarSubCategoriaPorId" validate="true" >
                            <s:iterator value="listaSubCategoria">
                                <tr align="center">
                                    <td><s:textfield key="nombre" label="nombre" value="%{nombre}" ></s:textfield></td>
                                    <td><s:textfield key="descripcion" label="Descripción"  value="%{descripcion}" ></s:textfield></td>
                                    <s:hidden name="idSubcategoria" value="%{idSubCategoria}"></s:hidden>
                                    </tr>
                            </s:iterator>
