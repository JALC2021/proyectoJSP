                ...
                <div class="top-nav">
                    <ul class="memenu skyblue"><li class="active"><a href="#">Inicio</a></li>
                        ...
                        <s:iterator value="listaUsuario">
                            <s:if test="tipoUsuario=='user'">
                                <s:include value="../include/menu/menuUser.jsp" ></s:include>
                            </s:if>
                            <s:elseif test="tipoUsuario=='admin'">
        ...
        <div class="shoes"> 
            <div class="container"> 
                <div class="product-one">
                    ...
                    %>
                    <ul>
                        <s:iterator value="#session.listaCategoria">
                            <s:hidden value="idCategoria"/>                       
                            <s:url action="../actions/mostrarSubCategoriaPorIdCategoria" var="urlTag" >
